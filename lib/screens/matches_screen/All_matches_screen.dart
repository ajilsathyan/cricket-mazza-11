...
import 'package:cricket_mazza_11/screens/player_profile_screen.dart';
                 ...
                 InkWell(
                   ...
                   child: Container(
                     ...
                     child: Column(
                       ...
                       children: [
                         SizedBox(height: 10,),
                         Text(allMatchList[i].matchName!,style: GoogleFonts.montserrat(fontSize: 15),),
                         Row(
                           children: [
                             SizedBox(width: 20,),
                             Container(
                               ...
                               decoration: BoxDecoration(
                                 ...
                                 image: DecorationImage(
                                   image: AssetImage(allMatchList[i].image1!)
                                   ,fit: BoxFit.fill,
                                 )
                               ),
                             ),
                             ...
                             Container(
                               ...
                               decoration: BoxDecoration(
                                   ...
                                   borderRadius: BorderRadius.circular(100),
                                   image: DecorationImage(
                                     image: AssetImage(allMatchList[i].image2!)
                                     ,fit: BoxFit.fill,
                                   )
                               ),
                             ),
