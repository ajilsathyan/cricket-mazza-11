...
class TestMatchScreen extends StatelessWidget {
  const TestMatchScreen({Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(height: 10,),
                          Text(test_list[i].matchName!,style: GoogleFonts.montserrat(fontSize: 15),),
                          Row(
                            children: [
                              SizedBox(width: 20,),
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: AssetImage(test_list[i].image1!)
                                      ,fit: BoxFit.fill,
                                    )
                                ),
                              ),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(100),
                                    image: DecorationImage(
                                      image: AssetImage(test_list[i].image2!)
                                      ,fit: BoxFit.fill,
                                    )
                                ),
                              ),
